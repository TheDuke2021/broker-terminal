...
### TCP-сервер
  ...
  *  TCP-сервер имеет свой time-out на запросы к сервисам биржевой информации. Если сервис БИ не ответил на запрос сервера в течение 5 секунд (это может быть запрос на выполнение команды или запрос статуса), сервер разрывает связь с данными сервисом БИ;
...
### Фронт-энд
  ...
  * Вывод информации от сервисов биржевой информации в  виде таблицы;
...
## Скриншоты проекта
 ...
 ![start_page](https://imgur.com/NMPYVbM.png)
 
 Выбор сервиса из списка, а также вкладка со списком команд:
 
 ![service_select](https://imgur.com/0W5XIRe.png)
 
 Вывод таблицы с данными (статуса сервиса), а также оценки задержки данных:
 
 ![service_status](https://imgur.com/RU6dQpF.png)
 
 Отправляемые от клиента запросы можно отследить в консоли (для отладки):
 
 ![debug](https://imgur.com/zeitI12.png)
 
 Адаптивный дизайн:
 
 ![adaptive_design1](https://imgur.com/xZUORlL.png)

![adaptive_design2](https://imgur.com/1d9Asd5.png)
